...
export const getProperties = async (
  ...
  try {
    ...
    // ✅ Handle amenities parsing safely
    let amenities: string[] = [];
    const rawAmenities = req.query.amenities;

    if (typeof rawAmenities === 'string') {
      amenities = rawAmenities.split(',').filter(Boolean);
    ...
    // ✅ FIXED: Properly bind amenities as TEXT[] array
  ...
  whereConditions.push(
    ...
    `;
    const properties = await prisma.$queryRaw(completeQuery, ...amenities);
